...
atomic_composition = {
    ...
    "H": {"protons": 1, "neutrons": 0, "quantity": 5},
    "N": {"protons": 7, "neutrons": 7, "quantity": 5},
    "O": {"protons": 8, "neutrons": 8, "quantity": 1}
}
...
for element in atomic_composition:
    ...
    print(f"{element}: {mass_quarks_up_protons} Kg quarks up protons, {mass_quarks_down_protons} Kg quarks down neutrons")
    ...
    print(f"{element}: {mass_quarks_up_neutrons} Kg quarks up protons, {mass_quarks_down_neutrons} Kg quarks down neutrons")
